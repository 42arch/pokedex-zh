...
import { PlusIcon, TrashIcon, XIcon, MagnifyingGlassIcon, WarningIcon, CheckCircleIcon } from '@phosphor-icons/react'
...
const typeMatchups: Record<PokemonType, Record<PokemonType, number>> = {
  '一般': {
    '一般': 1, '火': 1, '水': 1, '电': 1, '草': 1, '冰': 1, '格斗': 1, '毒': 1, '地面': 1, '飞行': 1, '超能力': 1, '虫': 1, '岩石': 0.5, '幽灵': 0, '龙': 1, '恶': 1, '钢': 0.5, '妖精': 1
  },
  '火': {
    '一般': 1, '火': 0.5, '水': 0.5, '电': 1, '草': 2, '冰': 2, '格斗': 1, '毒': 1, '地面': 1, '飞行': 1, '超能力': 1, '虫': 2, '岩石': 0.5, '幽灵': 1, '龙': 0.5, '恶': 1, '钢': 2, '妖精': 1
  },
  '水': {
    '一般': 1, '火': 2, '水': 0.5, '电': 1, '草': 0.5, '冰': 1, '格斗': 1, '毒': 1, '地面': 2, '飞行': 1, '超能力': 1, '虫': 1, '岩石': 2, '幽灵': 1, '龙': 0.5, '恶': 1, '钢': 1, '妖精': 1
  },
  '电': {
    '一般': 1, '火': 1, '水': 2, '电': 0.5, '草': 0.5, '冰': 1, '格斗': 1, '毒': 1, '地面': 0, '飞行': 2, '超能力': 1, '虫': 1, '岩石': 1, '幽灵': 1, '龙': 0.5, '恶': 1, '钢': 1, '妖精': 1
  },
  '草': {
    '一般': 1, '火': 0.5, '水': 2, '电': 1, '草': 0.5, '冰': 1, '格斗': 1, '毒': 0.5, '地面': 2, '飞行': 0.5, '超能力': 1, '虫': 0.5, '岩石': 2, '幽灵': 1, '龙': 0.5, '恶': 1, '钢': 0.5, '妖精': 1
  },
  '冰': {
    '一般': 1, '火': 0.5, '水': 0.5, '电': 1, '草': 2, '冰': 0.5, '格斗': 1, '毒': 1, '地面': 2, '飞行': 2, '超能力': 1, '虫': 1, '岩石': 1, '幽灵': 1, '龙': 2, '恶': 1, '钢': 0.5, '妖精': 1
  },
  '格斗': {
    '一般': 2, '火': 1, '水': 1, '电': 1, '草': 1, '冰': 2, '格斗': 1, '毒': 0.5, '地面': 1, '飞行': 0.5, '超能力': 0.5, '虫': 0.5, '岩石': 2, '幽灵': 0, '龙': 1, '恶': 2, '钢': 2, '妖精': 0.5
  },
  '毒': {
    '一般': 1, '火': 1, '水': 1, '电': 1, '草': 2, '冰': 1, '格斗': 1, '毒': 0.5, '地面': 0.5, '飞行': 1, '超能力': 1, '虫': 1, '岩石': 0.5, '幽灵': 0.5, '龙': 1, '恶': 1, '钢': 0, '妖精': 2
  },
  '地面': {
    '一般': 1, '火': 2, '水': 1, '电': 2, '草': 0.5, '冰': 1, '格斗': 1, '毒': 2, '地面': 1, '飞行': 0, '超能力': 1, '虫': 0.5, '岩石': 2, '幽灵': 1, '龙': 1, '恶': 1, '钢': 2, '妖精': 1
  },
  '飞行': {
    '一般': 1, '火': 1, '水': 1, '电': 0.5, '草': 2, '冰': 1, '格斗': 2, '毒': 1, '地面': 1, '飞行': 1, '超能力': 1, '虫': 2, '岩石': 0.5, '幽灵': 1, '龙': 1, '恶': 1, '钢': 0.5, '妖精': 1
  },
  '超能力': {
    '一般': 1, '火': 1, '水': 1, '电': 1, '草': 1, '冰': 1, '格斗': 2, '毒': 2, '地面': 1, '飞行': 1, '超能力': 0.5, '虫': 1, '岩石': 1, '幽灵': 1, '龙': 1, '恶': 0, '钢': 0.5, '妖精': 1
  },
  '虫': {
    '一般': 1, '火': 0.5, '水': 1, '电': 1, '草': 2, '冰': 1, '格斗': 0.5, '毒': 0.5, '地面': 1, '飞行': 0.5, '超能力': 2, '虫': 1, '岩石': 1, '幽灵': 0.5, '龙': 1, '恶': 2, '钢': 0.5, '妖精': 0.5
  },
  '岩石': {
    '一般': 1, '火': 2, '水': 1, '电': 1, '草': 1, '冰': 2, '格斗': 0.5, '毒': 1, '地面': 0.5, '飞行': 2, '超能力': 1, '虫': 2, '岩石': 1, '幽灵': 1, '龙': 1, '恶': 1, '钢': 0.5, '妖精': 1
  },
  '幽灵': {
    '一般': 0, '火': 1, '水': 1, '电': 1, '草': 1, '冰': 1, '格斗': 1, '毒': 1, '地面': 1, '飞行': 1, '超能力': 2, '虫': 1, '岩石': 1, '幽灵': 2, '龙': 1, '恶': 0.5, '钢': 1, '妖精': 1
  },
  '龙': {
    '一般': 1, '火': 1, '水': 1, '电': 1, '草': 1, '冰': 1, '格斗': 1, '毒': 1, '地面': 1, '飞行': 1, '超能力': 1, '虫': 1, '岩石': 1, '幽灵': 1, '龙': 2, '恶': 1, '钢': 0.5, '妖精': 0
  },
  '恶': {
    '一般': 1, '火': 1, '水': 1, '电': 1, '草': 1, '冰': 1, '格斗': 0.5, '毒': 1, '地面': 1, '飞行': 1, '超能力': 2, '虫': 1, '岩石': 1, '幽灵': 2, '龙': 1, '恶': 0.5, '钢': 1, '妖精': 0.5
  },
  '钢': {
    '一般': 1, '火': 0.5, '水': 0.5, '电': 0.5, '草': 1, '冰': 2, '格斗': 1, '毒': 1, '地面': 1, '飞行': 1, '超能力': 1, '虫': 1, '岩石': 2, '幽灵': 1, '龙': 1, '恶': 1, '钢': 0.5, '妖精': 2
  },
  '妖精': {
    '一般': 1, '火': 0.5, '水': 1, '电': 1, '草': 1, '冰': 1, '格斗': 2, '毒': 0.5, '地面': 1, '飞行': 1, '超能力': 1, '虫': 1, '岩石': 1, '幽灵': 1, '龙': 2, '恶': 2, '钢': 0.5, '妖精': 1
  }
}
...
export function TeamPlanner({ pokemonList }: TeamPlannerProps) {
  ...
  const filteredPokemons = React.useMemo(() => {
    ...
    if (!q) return pokemonList.slice(0, 50) // default limit for list performance
